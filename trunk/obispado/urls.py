...
urlpatterns = patterns('',
    ...
    (r'^asientos_list/', 'obispado.libros_contables.views.list_asientos'),
    (r'^asientos_edit/(?P<a_id>\d+)', 'obispado.libros_contables.views.edit_asientos'),
    (r'^asientos_update/', 'obispado.libros_contables.views.update_asientos'),
    ...
    (r'^balances/csv/$', 'obispado.balances.views.index'),
    (r'^balances/generar_balance', 'obispado.balances.views.generar_balance'),
