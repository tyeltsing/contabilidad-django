# Django settings for obispado project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'contabilidad_obispado',                      # Or path to database file if using sqlite3.
        'USER': 'obispado',                      # Not used with sqlite3.
